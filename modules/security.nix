...

{
  ...
  # XXX this prevent hibernating.
  # appends the nohibernate kernel parameter so that a running, locked-down kernel can never
  # be replaced from the hibernation image.
